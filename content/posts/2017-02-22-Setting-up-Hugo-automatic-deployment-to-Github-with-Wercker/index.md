...
{{< figure src="/images/2017-02-22/wercker-steps.png" caption="Wercker → Registry → steps" caption-position="bottom" caption-effect="appear">}}
...
{{< figure src="/images/2017-02-22/wercker-pipeline.png" caption="Wercker Pipeline" caption-position="bottom" caption-effect="appear">}}

You need to generate a new access token for your deploy stage from Github settings.
{{< figure src="/images/2017-02-22/wercker-access-token.png" caption="Github Access Token" caption-position="bottom" caption-effect="appear">}}

After adding the deploy stage, add the token you obtained from the Github to Environmental Variables in deploy pipeline.

{{< figure src="/images/2017-02-22/wercker-token.png" caption="Wercker Token" caption-position="bottom" caption-effect="appear">}}
